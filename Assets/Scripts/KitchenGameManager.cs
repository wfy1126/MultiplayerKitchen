...
public class KitchenGameManager : NetworkBehaviour {
    ...
    private Dictionary<ulong, bool> playerPausedDictory;
    ...
    private void Awake() {
        ...
        playerPausedDictory = new Dictionary<ulong, bool>();
    }
    ...
    {
        playerPausedDictory[serverRpcParams.Receive.SenderClientId] = true;
    ...
    {
        playerPausedDictory[serverRpcParams.Receive.SenderClientId] = false;
        TestGamePausedState();
    }
    ...
    private void TestGamePausedState()
    {
        foreach(ulong clientID in NetworkManager.Singleton.ConnectedClientsIds)
        {
            if(playerPausedDictory.ContainsKey(clientID) && playerPausedDictory[clientID])
            {
